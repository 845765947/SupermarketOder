...
$(function() {
	...
	$.ajax({
		type : "GET",// 请求类型
		url : path + "/user/selectRole",// 请求的url
		data : {
			method : "getrolelist"
		},// 请求参数
	 ...
	 * }).on("blur",function(){ if(userRole.val() != null && userRole.val() >
	 * 0){ validateTip(userRole.next(),{"color":"green"},imgYes,true); }else{
