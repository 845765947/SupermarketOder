...
<div class="right">
	...
	<div class="providerAdd">
		<form id="providerForm" name="providerForm" method="post"
			action="${pageContext.request.contextPath }/provider/provideradd"
			...
			<div>
				...
				<label for="a_idPicPath">企业营业执照:</label> <input type="file"
					name="attachs" id="businessLicense"> <font color="red"></font>
			</div>

			<div>
				<input type="hidden" id="errorinfo" value="${uploadWpError }">
				<label for="a_idPicPath">组织机构代码证:</label> <input type="file"
					name="attachs" id="organizationCodeCertificate"> <font
					color="red"></font>
			</div>
