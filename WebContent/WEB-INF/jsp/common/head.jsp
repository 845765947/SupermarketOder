	...
	<section class="publicMian ">
		<div class="left">
			...
			<nav>
				<ul class="list">
					<li><a
						href="${pageContext.request.contextPath }/statics/jsp/bill.do?method=query">订单管理</a></li>
					<li><a
						href="${pageContext.request.contextPath }/provider/providerlist.html">供应商管理</a></li>
					<li><a
						href="${pageContext.request.contextPath }/user/userlist.html">用户管理</a></li>
					<li><a
						href="${pageContext.request.contextPath }/user/sys/pwdUpdateView">密码修改</a></li>
					<li><a
