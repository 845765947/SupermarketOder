...
public class UserDaoImpl implements UserDao {
	...
	public List<User> getListUser(Connection conn) {
		...
		try {
			if (conn != null) {
				String sql = "SELECT u.id,u.userCode,u.userName,u.userPassword,u.gender,u.phone,r.roleName FROM `smbms_user` u,smbms_role r where u.userRole=r.id";
				...
				while (rs.next()) {
					...
					user.setUserRoleName(rs.getString(7));
					list.add(user);
				}
