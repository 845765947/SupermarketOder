...
<div class="right">
	...
	<div class="providerAdd">
		<form id="userForm" method="post"
			action="${pageContext.request.contextPath}/user/user.do"
			...
			<div>
				...
				<select name="userRole" id="userRole">
					<option value="3">咸鱼胖</option>
				</select> <font color="red"> </font>
			</div>
			<div>
				<input type="hidden" id="errorinfo" value="${uploadFileError }">
				<label for="a_idPicPath">证件照</label> <input type="file"
					name="attachs" id="a_idPicPath"> <font color="red"></font>
			</div>
			<div>
				<input type="hidden" id="errorinfo" value="${uploadWpError }">
				<label for="a_idPicPath">工作证照片：</label> <input type="file"
